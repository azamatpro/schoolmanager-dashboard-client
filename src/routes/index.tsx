...
const AddStudent = React.lazy(() => import('../pages/apps/Students/AddStudent'));
const EditStudent = React.lazy(() => import('../pages/apps/Students/EditStudent'));
const StudentsList = React.lazy(() => import('../pages/apps/Students/StudentsList'));
const AddCourse = React.lazy(() => import('../pages/apps/Courses/AddCourse'));
const EditCourse = React.lazy(() => import('../pages/apps/Courses/EditCourse'));
const CoursesList = React.lazy(() => import('../pages/apps/Courses/CoursesList'));
const AddRoom = React.lazy(() => import('../pages/apps/Rooms/AddRoom'));
const EditRoom = React.lazy(() => import('../pages/apps/Rooms/EditRoom'));
const RoomsList = React.lazy(() => import('../pages/apps/Rooms/RoomsList'));
const AddSchedual = React.lazy(() => import('../pages/apps/Scheduals/AddSchedual'));
const EditSchedual = React.lazy(() => import('../pages/apps/Scheduals/EditSchedual'));
const SchedualsList = React.lazy(() => import('../pages/apps/Scheduals/SchedualsList'));
const AddFee = React.lazy(() => import('../pages/apps/Fees/AddFee'));
const EditFee = React.lazy(() => import('../pages/apps/Fees/EditFee'));
const FeesList = React.lazy(() => import('../pages/apps/Fees/FeesList'));
const AddFeedback = React.lazy(() => import('../pages/apps/Feedbacks/AddFeedback'));
const EditFeedback = React.lazy(() => import('../pages/apps/Feedbacks/EditFeedback'));
const FeedbacksList = React.lazy(() => import('../pages/apps/Feedbacks/FeedbacksList'));
            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        {
                            path: 'adminstrators/add',
                            element: <LoadComponent component={AddAdminstrator} />,
                        },
                        {
                            path: 'adminstrators/edit/:id',
                            element: <LoadComponent component={EditAdminstrator} />,
                        },
                        {
                            path: 'teachers',
                            element: <LoadComponent component={TeachersList} />,
                        },
                        {
                            path: 'teachers/add',
                            element: <LoadComponent component={AddTeacher} />,
                        },
                        {
                            path: 'teachers/edit',
                            element: <LoadComponent component={EditTeacher} />,
                        },
                        {
                            path: 'students',
                            element: <LoadComponent component={StudentsList} />,
                        },
                        {
                            path: 'students/add',
                        ...
                        {
                            path: 'courses',
                            element: <LoadComponent component={CoursesList} />,
                        },
                        {
                            path: 'courses/add',
                            element: <LoadComponent component={AddCourse} />,
                        },
                        {
                            path: 'courses/edit',
                            element: <LoadComponent component={EditCourse} />,
                        },
                        {
                            path: 'rooms',
                            element: <LoadComponent component={RoomsList} />,
                        },
                        {
                            path: 'rooms/add',
                            element: <LoadComponent component={AddRoom} />,
                        },
                        {
                            path: 'rooms/edit',
                            element: <LoadComponent component={EditRoom} />,
                        },
                        {
                            path: 'scheduals',
                            element: <LoadComponent component={SchedualsList} />,
                        },
                        {
                            path: 'scheduals/add',
                            element: <LoadComponent component={AddSchedual} />,
                        },
                        {
                            path: 'scheduals/edit/',
                            element: <LoadComponent component={EditSchedual} />,
                        },
                        {
                            path: 'fees',
                            element: <LoadComponent component={FeesList} />,
                        },
                        {
                            path: 'fees/add',
                            element: <LoadComponent component={AddFee} />,
                        },
                        {
                            path: 'fees/edit',
                            element: <LoadComponent component={EditFee} />,
                        },
                        {
                            path: 'feedbacks',
                            element: <LoadComponent component={FeedbacksList} />,
                        },
                        {
                            path: 'feedbacks/add',
                            element: <LoadComponent component={AddFeedback} />,
                        },
                        {
                            path: 'feedbacks/edit',
                            element: <LoadComponent component={EditFeedback} />,
                        },
                        ////
                        {
                            path: 'calendar',
